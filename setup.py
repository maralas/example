...
setup(
    name='topology_lib_example',
    version=find_version('lib/topology_lib_example/__init__.py'),
    package_dir={'': 'lib'},
    ...
    url='https://github.com/HPENetworking/topology_lib_example/tree/master/doc',
    keywords='topology_lib_example',
    ...
    entry_points={
        'topology_library_10': [
            'example = topology_lib_example.library'
        ]
    }
)
